...
<div class="wrapper">
            ...
            <div class="thumbnail">
              ...
              <div class="caption text-center">
                ...
                <div class="row">
                  <?php
                  if(isset($_SESSION["id_user"]) && empty($_SESSION['companyLogged'])){ ?>
                  <div class="col-md-4"><a href="apply.php?id=<?php echo $row['id_jobpost']; ?>"><i class="fa fa-address-card-o"></i> Apply</a>
                  </div>
                  <?php } ?>
  ...
  <footer class="main-footer" style="margin-left: 0px;">
    <div class="text-center">
      <strong>Copyright &copy; 2022-2022 <a href="jonsnow.netai.net">Job Portal</a>.</strong> All rights
    reserved.
    </div>
  </footer>
